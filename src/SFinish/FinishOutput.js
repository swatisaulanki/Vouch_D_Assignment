          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div className="cart cart-lite">
              <div className="cart-contant">
                ...
                <div className="profile_name">ISS Facility Services</div>
                <div className="profile_value">4 Clients</div>
              </div>
              <div className="cart-btn-sect">
                <button
                  className="btn-liteGay form-btn font-btn fit-btn"
                  type="button"
                >
                  <span className="text">Add More Clients</span>
                </button>
                <button
                  className="btn-transperent  font-btn fit-btn"
                  type="button"
                >
                  All
                </button>
          ...
          <div className="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
            <div className="cart cart-lite">
              <div className="cart-contant">
                ...
                <div className="profile_name">Infosys</div>
