...
const Asidebar = ({ Toggle, Acount_ids }) => {
  const [Acount_id, SetAcount_id] = useState(Acount_ids);
  return (
    <div
      className={Toggle ? "asidebar_container active" : "asidebar_container"}
    >
      <div className="asidebar">
        <div className="container_asidebar">
          <div className="Company">Company name</div>
          <div className="menu-asidebar">
            ...
            <div className="asidebar-title">Client Master</div>

            <div className="viewLink_container">
              <div
                className={Acount_id === 1 ? "ViewLink active" : "ViewLink"}
                onClick={() => SetAcount_id(1)}
              >
                <NavLink to="/Datav_Clients">View Clients </NavLink>
              </div>
              <div
                className={Acount_id === 2 ? "ViewLink active" : "ViewLink"}
                onClick={() => SetAcount_id(2)}
              >
                <NavLink to="/Created_Profile">Add Client </NavLink>
              </div>
            </div>
          </div>
        </div>
