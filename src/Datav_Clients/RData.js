    ...
    <tr>
      <td>
        <div className="user-td">
          <img className="user-td-img" src={logos} alt="" />
          <span>{Companies_Name}</span>
        </div>
      </td>
      <td>
      ...
      <td>
        <div className="oparetion">
          <button className="op-btn" id={`Op_${id}`}>
            <svg
              width="4"
              height="16"
              viewBox="0 0 4 16"
