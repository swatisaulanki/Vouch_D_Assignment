...
const ListData = ({id, modes_name, child, SetCurChild }) => {
  return (
    <>
...
const Mdatas = () => {
  const [MChild, SetMChild] = useState(6);
                ...
                {data.map((CurElem) => {
                  return (
                    <div
                      ...
                      onClick={() => {
                        SetMChild(CurElem.id - 1);
                      }}
                    >
                      <ListData key={CurElem.id} {...CurElem} />
                    </div>
                  );
                })}
              </div>
